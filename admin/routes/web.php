...
Route::get ('/company-contact-persons/{id}', 'CompanyController@contactPersonsList')       ->name('company.persons.show');
Route::post('/company-contact-persons',      'CompanyController@getAllContactPersonsList') ->name('company.persons.getAllData');
...
Route::get ('/tender-type-list',     'TenderTypeController@tenderTypes')      ->name('tenderType');
Route::post('/get-tender-type-list', 'TenderTypeController@getAlltenderType')->name('tenderType.getAllData');
Route::post('/insert-tender-type',   'TenderTypeController@insertTenderType') ->name('tenderType.insert');
Route::post('/edit-tender-type',     'TenderTypeController@editTenderType')   ->name('tenderType.edit');
Route::post('/update-tender-type',   'TenderTypeController@updateTenderType') ->name('tenderType.update');
Route::post('/delete-tender-type',   'TenderTypeController@deleteTenderType') ->name('tenderType.delete');